...
var SVG_SYMBOLS = {
  ...
  '(': {
    width: '.55em',
    html:
      '<svg preserveAspectRatio="none" viewBox="-50 0 190 348">' +
        '<path d="M90,345c0,2.2-1.2,3.4-3.6,3.4c-1.4,0-4.2-1.8-8.6-5.4c-28.2-23.2-48.3-48-60.4-74.4' +
        'C5.6,242.6-0.3,211.2-0.3,174.2c0-37,5.9-68.5,17.8-94.4C29.5,53.4,49.7,28.6,77.8,5.4C82.2,1.8,' +
        '85,0,86.4,0C88.8,0,90,1.1,90,3.4c0,1-1.5,3-4.5,6C48.1,46.1,29.4,101,29.4,174.2S48.1,302.3,85.5,' +
        '339C88.5,342,90,344,90,345z" />' +
      '</svg>'
  },
  ')': {
    width: '.55em',
    html:
      '<svg preserveAspectRatio="none" viewBox="-50 0 190 348">' +
        '<path d="M4.2,339c37.4-36.8,56.1-91.7,56.1-164.8S41.6,46.1,4.2,9.3c-3-3-4.5-5-4.5-6C-0.3,1.1,0.9,0,3.2,' +
        '0c1.4,0,4.2,1.8,8.6,5.4c28.2,23.2,48.3,48,60.4,74.4C84,105.7,90,137.2,90,174.2c0,37-5.9,68.5-17.8,' +
        '94.4C60.1,295,40,319.8,11.8,342.9c-4.4,3.6-7.2,5.4-8.6,5.4c-2.4,0-3.6-1.1-3.6-3.4C-0.3,344,1.2,342,4.2,339z" />' +
      '</svg>'
  },
  '{': {
    width: '.7em',
